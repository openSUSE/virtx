...
func host_get(host *openapi.Host) {
	if (virtx.stat) {
		fmt.Fprintf(virtx.w, "  CPU_TOTAL\t   CPU_USED\t   CPU_FREE\tCPU_USED_OS\tCPU_USED_VM\t CPU_RES_VM\t CPU_AVL_VM\t  MEM_TOTAL\t   MEM_USED\t   MEM_FREE\tMEM_USED_OS\tMEM_USED_VM\t MEM_RES_VM\t MEM_AVL_VM\n")
		fmt.Fprintf(virtx.w, "%7d MHz\t%7d MHz\t%7d MHz\t%7d MHz\t%7d MHz\t%7d MHz\t%7d MHz\t%7d MiB\t%7d MiB\t%7d MiB\t%7d MiB\t%7d MiB\t%7d MiB\t%7d MiB\n",
